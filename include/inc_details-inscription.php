...
<p>
        ...
        par tous. En effet, chaque contenu devra, tout au long du festival, être libre de
        droit afin d’être utilisé pour les trailers, After-Movie ou encore pour leur diffusion
        sur la chaine Youtube de l’événement.
</p>
<h1>L’inscription :</h1>
<p>
        Réservée aux étudiants.<br />
        Par le biais du site.<br />
        S’engage à respecter le règlement.
</p>
<h1>L’envoi :</h1>
<p>
        L'envoi se fait sur le site au plus tard le <time>dimanche 18 février 2018 à 23H59</time>. Toute vidéo dépassant cette date butoir ne sera pas prise en compte.
</p>
...
<form method="post" action="http://www.frammi.fr/pages/inscription.php">
